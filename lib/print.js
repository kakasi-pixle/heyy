...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(
    `${line} ${chalk.cyanBright('🔧 Bot')}        : ${chalk.greenBright(me)} ${chalk.magentaBright('~ ' + conn.user.name)}${conn.user.jid == global.conn.user.jid ? '' : chalk.redBright(' (SUB BOT)')}
${sep}
${line} ${chalk.cyanBright('🕒 Time')}       : ${chalk.blueBright(
      (m.messageTimestamp
...
${sep}
${line} ${chalk.cyanBright('📌 Event')}      : ${chalk.redBright(
      m.messageStubType ? WAMessageStubType[m.messageStubType] : 'None'
    )}
${sep}
${line} ${chalk.cyanBright('🧱 Size')}       : ${chalk.yellowBright(filesize + ' B')}
${sep}
${line} ${chalk.cyanBright('📤 Sender')}     : ${chalk.redBright(sender)}
${sep}
${line} ${chalk.cyanBright('👤 User')}       : ${chalk.greenBright(
      user
        ? `EXP:${user.exp} | 💰:${user.money}`
        : `LV:${user.level} | 🔋:${user.limit}`
    )}
${sep}
${line} ${chalk.cyanBright('💬 Chat')}       : ${chalk.redBright(m.chat)}${chat ? chalk.greenBright(' ~ ' + chat) : ''}
${sep}
${line} ${chalk.cyanBright('📨 Message')}    : ${chalk.yellowBright(
      m.mtype
        ? m.mtype
          .replace(/message$/i, '')
